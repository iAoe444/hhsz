...
#define MQTT_CLIENT_ID        "huapen001"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define STA_SSID "ITC404"    // your AP/router SSID to config your device networking
#define STA_PASS "itc404wifi" // your AP/router password
